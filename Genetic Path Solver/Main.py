...
def mazeSolver():
    global INITIAL_POPULATION, MUTATION_PROBABILITY_HARDWARE, MUTATION_PROBABILITY_BEHAVIOUR, GEN_COUNT, ARCHIVE, ADAPTABILITY_RECORD
...
GENERATIONS = 500 # change to while true
